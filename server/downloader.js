...
router.get('/play', async(req, res) => {
	...
	var hasil = await axios.get('https://lusifar-api.herokuapp.com/downloader/youtube?link='+vid.url)
	try {
		res.json(hasil.data)
	} catch(err) {
		console.log(err)
...
router.get('/spotify', async(req, res) => {
	...
	try {
		res.json({ info: hasil, dl_lnk: `https://lusifar-api.herokuapp.com/downloader/spotifydl?link=${link}` })
	} catch(err) {
		console.log(err)
		res.json({ message: 'Ups, error' })
	}
