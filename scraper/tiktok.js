...
const titoko = `https://lusifar-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
const tikitoko = `https://lusifar-api.herokuapp.com/converter/tomp3?url=https://lusifar-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
const obj = {
	videoInfo: {
		id: ingfo.id,
		desc: ingfo.text,
