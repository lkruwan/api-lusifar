			...
			pickrandom(Vidlink).then(res => {
				axios.get(res).then(respon => {
					...
					resolve({
						...
						nowm: 'https://lusifar-api.herokuapp.com/downloader/tiktoknowm?link='+ch('#tiktok-video-result > div > div.download-buttons > div > a').attr('href').replace('https://savetiknowm.org/?tiktok_url=', ''),
